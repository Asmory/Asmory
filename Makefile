...
cli: $(CLI_BIN) $(ACQUIRE_HELPER) $(CACHE_HELPER)
...
install-user: $(CLI_BIN) $(ACQUIRE_HELPER) $(CACHE_HELPER)
	...
	@echo 'installed: $(HOME)/.local/bin/asmory + asmory-acquire + asmory-cache'
